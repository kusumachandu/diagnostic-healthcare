        ...
        <Formik
          ...
          <form onSubmit={handleSubmit} className="text-left">
            <div className="">
              ...
              <input
                className={`w-full mb-1 bg-gray-300 text-gray-900 p-3 rounded-lg focus:outline-none focus:shadow-outline ${errors.name && touched.name
              ...
              />
              {errors.name && touched.name && <div className="mt-[-5px] text-red-500">{errors.name}</div>}
              ...
              <input
                className={`w-full bg-gray-300 mb-1 text-gray-900 p-3 rounded-lg focus:outline-none focus:shadow-outline ${errors.email && touched.email 
                  ? "border border-red-700 bg-red-100"
                  : ""}`}
                type="email"
                name="email"
                ...
                value={values.email}
              />
              {errors.email && touched.email && <div className="mt-[-5px] text-red-500">{errors.email}</div>}
              <div className="mb-2"></div>
              ...
              <input
                className={`w-full bg-gray-300 mb-1 text-gray-900 p-3 rounded-lg focus:outline-none focus:shadow-outline ${errors.mobile && touched.mobile 
                  ? "border border-red-700 bg-red-100"
                  : ""}`}
                type="text"
                name="mobile"
                ...
                value={values.mobile}
              />
              {errors.mobile && touched.mobile && <div className="mt-[-5px] text-red-500">{errors.mobile}</div>}
              <div className="mb-2"></div>
              ...
              <input
                className={`w-full bg-gray-300 mb-1 text-gray-900 p-3 rounded-lg focus:outline-none focus:shadow-outline ${errors.date && touched.date 
                  ? "border border-red-700 bg-red-100"
                  : ""}`}
                type="date"
                name="date"
